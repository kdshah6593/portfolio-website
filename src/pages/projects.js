...
const LiveProject = props => (
  <CardWrapper>
    ...
    <CardText>
      ...
      <LinkWrapper>
        <CardLink to={props.github} target="_blank">
          Source Code
        </CardLink>
        <CardLink to={props.hosted} target="_blank">
          Live Site
        </CardLink>
      </LinkWrapper>
    </CardText>
  ...
  <CardWrapper>
    ...
    <CardText>
      ...
      <LinkWrapper>
        ...
        <CardLink to={props.demo} target="_blank">
          Demo
        </CardLink>
      </LinkWrapper>
    </CardText>
...
const Projects = () => {
  return (
    <Layout>
      <Seo title="Projects" />
      <div id="project-body">
        <h1 className="marker-font" id="project-header">
          Projects
        </h1>
        <CardContainer>
          <NotLiveProject
            ...
            image={SportsReport}
            github="https://github.com/kdshah6593/the-sports-report-frontend"
            demo="https://drive.google.com/file/d/18aaVMk6WiQocqqFsN9yqOk0urj0WQ1iq/view?usp=sharing"
          />
          <NotLiveProject
            title="StudyDecks"
            ...
            image={StudyDecks}
            github="https://github.com/kdshah6593/studydecks-frontend"
            demo="https://drive.google.com/file/d/1j6LyfAou76YZzb_HlSZoyFHgUZlIKk3O/view?usp=sharing"
          />
          <NotLiveProject
            title="Stock Tracker"
